...
class Discapacidades_motoras(models.Model):
    ...
    que_es_im = models.ImageField('', upload_to='perfiles',validators=[imagen_validador],null=True,blank=True)
    que_deve_conocer_familia=models.TextField("¿Que se debe conocer en el entorno familiar?")
    que_deve_im = models.ImageField('', upload_to='perfiles',validators=[imagen_validador],null=True,blank=True)
    recomendaciones=models.TextField("Recomendaciones")
    recomendaciones_im = models.ImageField('', upload_to='perfiles',validators=[imagen_validador],null=True,blank=True)
